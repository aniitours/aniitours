    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-12 font-caudex">Why choose Andaman Nicobar India International Tours</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center flex flex-col items-center">
              <img src={ticket} alt="" className="mb-4"/>
              <h3 className="font-bold mb-2">Flexible tour plans</h3>
            ...
            <div className="text-center flex flex-col items-center">
              ...
              <h3 className="font-bold mb-2">Simple and customised</h3>
              <p className="text-gray-600 w-2/3">
                Expertly curated tours with high-quality standards.
              </p>
            </div>
          </div>
        </div>
