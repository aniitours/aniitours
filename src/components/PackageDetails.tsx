        ...
        activities: [
          {
            ...
            description: 'Arrive in Port Blair'
          },
          {
            time: 'Evening',
            description: 'Visit Cellular Jail for The Light and Sound Show'
          },
          {
            time: 'Activity',
            description: "Explore The Historic Cellular Jail And Attend The Light And Sound Show To Learn About The History Of India's Freedom Struggle"
          }
        ]
      },
      {
        ...
        activities: [
          {
            time: 'Morning',
            description: 'Head To North Bay Island'
          },
          {
            time: 'Activity',
            description: 'Enjoy Water Activities Like Snorkeling, Glass-Bottom Boat Rides, And Underwater Sea Walking'
          },
          {
            time: 'Afternoon',
            description: 'Visit Ross Island'
          },
          {
            time: 'Activity',
            description: "Explore The Ruins Of British Administrative Buildings, A Church, And A Museum Showcasing The Island's History"
          }
        ]
      },
      {
        ...
        activities: [
          {
            time: 'Early Morning',
            description: 'Depart For Baratang Island'
          },
          {
            time: 'Activity',
            description: 'Journey Through The Jarawa Reserve Forest And Visit The Limestone Caves And Mud Volcano'
          },
          {
            time: 'Note',
            description: 'The Trip Involves A Long Drive And A Boat Ride Through Mangrove Creeks'
          }
        ]
      },
      {
        ...
        activities: [
          {
            time: 'Morning',
            description: 'Ferry To Havelock Island'
          },
          {
            time: 'Activity',
            description: 'Visit Elephant Beach For Snorkeling And Other Water Activities'
          },
          {
            time: 'Afternoon',
            description: 'Relax At Kalapathar Beach'
          },
          {
            time: 'Activity',
            description: 'Enjoy The Serene Beach Perfect For Relaxing And Photography'
          }
        ]
      },
      {
        ...
        activities: [
          ...
          {
            time: 'Activity',
            description: 'Experience Scuba Diving To Explore The Vibrant Underwater Life'
          },
          {
            time: 'Afternoon',
            description: 'Visit Radhanagar Beach'
          },
          {
            time: 'Activity',
            description: 'Relax At One Of The Best Beaches In Asia, Known For Its Stunning Sunsets'
          }
        ]
      },
      {
        ...
        activities: [
          {
            time: 'Morning',
            description: 'Return To Port Blair Via Ferry'
          },
          {
            time: 'Afternoon',
          ...
          {
            time: 'Activity',
            description: "Tour The Anthropological Museum, Samudrika Naval Marine Museum, And The Fisheries Museum To Learn About The Region's Culture, Marine Life, And History"
          }
        ]
      },
      {
        ...
        activities: [
          {
            time: 'Morning',
            description: 'Drop-Off At The Airport For Your Return Flight'
          }
        ]
      }
    ]
        ...
        <div className="py-12">
            <div className="container mx-auto px-4">
                ...
                {packageData.days.map((day, index) => (
                    <div key={index} className="relative pl-8 border-l-4 border-blue-200 border-dashed mb">
