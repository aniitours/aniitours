export const itineraryData = {
    ...
    days: [
        ...
        {
            day: 4,
            title: 'Swaraj Dweep, Radhanagar Beach & Neil Island',
            activities: [
                ...
                'Afternoon: Take a cruise trip to Neil Island and enjoy the sunset at Laxmanpur Beach.',
