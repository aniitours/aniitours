export const itineraryData = {
    ...
    days: [
        ...
        {
            day: 2,
            title: 'Swaraj Dweep, Elephant Island, Seawalk & Kaalapathar Beach',
            activities: [
                'Morning: Take a cruise trip to Swaraj Dweep, check in at the resort, and later enjoy a boat trip to Elephant Island for a seawalk activity.',
        ...
        {
            day: 3,
            title: 'Scuba Diving, Radhanagar Beach & Candlelight Dinner',
            activities: [
