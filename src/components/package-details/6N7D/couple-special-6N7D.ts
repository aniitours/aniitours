export const itineraryData = {
    ...
    subtitle: '2N Portblair, 2N Havelock, 2N Neil',
    days: [
        {
            day: 1,
        ...
        },
        {
            ...
            activities: [
                ...
                'Afternoon: Visit the natural Coral Bridge (comfortable footwear recommended), a unique rock formation.',
        ...
        {
            day: 3,
            title: 'Bharatpur Beach, Sitapur Beach & Ramnagar Beach',
            activities: [
                'Morning: Visit Bharatpur Beach, known for its water sports activities and vibrant marine life.',
                'Afternoon: Relax at Sitapur Beach, famous for its serene atmosphere and golden sands.',
        ...
        },
        {
            ...
            activities: [
                ...
                'Afternoon: Enjoy a boat trip to Elephant Island Beach, known for its crystal-clear waters and vibrant marine life.',
        ...
        },
        {
            ...
            activities: [
                'Morning: Visit the world-famous Radhanagar Beach, perfect for swimming and known for its Blue Flag rating, blue waters, and white sandy shores.',
