export const itineraryData = {
    ...
    days: [
        ...
        {
            day: 5,
            title: 'Bharatpur Beach and sitapur beach',
            activities: [
        ...
        },
        {
            ...
            activities: [
                'After checkout, return to the capital from the jetty. Head to Coral Island (North Bay), a popular destination for watersports like snorkeling, scuba diving, parasailing, and boat rides. Visit the lighthouse for a picturesque view of the surroundings.',
