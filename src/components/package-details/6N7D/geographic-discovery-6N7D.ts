export const itineraryData = {
    ...
    days: [
        ...
        },
        {
            ...
            activities: [
                'Morning: Embark on a mini city tour, visiting museums (Anthropological Museum, Samudrika Naval Museum, and Chatham Museum).',
                'Afternoon: Enjoy some last-minute shopping.',
